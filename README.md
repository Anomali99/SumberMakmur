# SumberMakmur
SumberMakmur adalah aplikasi untuk memanjemen toko bangunan sederhana; 
...
- [MySQL Connector](https://drive.google.com/drive/folders/1Vax-3HV8EhI8Ics2cibPwG8Hi2XSUoCm?usp=drive_link)
- [RojeruSan](https://drive.google.com/drive/folders/1lEP6UmcynHRKaN7HiQBNhMW6UaaJg0Kx?usp=drive_link)
- [JNA](https://drive.google.com/drive/folders/1MAdL8nWkbM-8jKJnc-wTgr7QcXFp8Yha?usp=drive_link)
- [JasperReport](https://drive.google.com/drive/folders/1j5_8GSWe5ZPekZ98PfehL3avy_HWa5Jr?usp=drive_link)


## Installation

Buat database `sumber_makmur` di phpMyAdmin
```sh
-- phpMyAdmin SQL Dump
-- version 5.2.1
...
>Kemudian login dengan username `admin` dan password `admin`


=======
> Nur Fatiq (09040622071)
>Fahmi Surya Hidayat (09020622025)
