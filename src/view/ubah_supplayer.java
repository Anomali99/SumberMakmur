 ...
 * @author fatiq
 */
public class ubah_supplayer extends javax.swing.JDialog {
    ...
    private table_supplayer tblMod = new table_supplayer();
    private model_supplayer mod;
    
    public ubah_supplayer(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        model_supplayer mod = servis.getByID(id);
        tf_id.setText(mod.getId_supplayer());
        tf_nama.setText(mod.getNama_supplayer());
        tf_alamat.setText(mod.getAlamat_supplayer());
        tf_tlp.setText(mod.getTlp_supplayer());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ubah Data Supplayer");
        ...
        jPanel1.add(btn_tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 250, 120, 40));
        ...
        jPanel1.add(btn_batal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 250, 120, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ubah_supplayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ubah_supplayer dialog = new ubah_supplayer(new javax.swing.JFrame(), true,"id");
