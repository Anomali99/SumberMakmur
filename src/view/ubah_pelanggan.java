 ...
 * @author fatiq
 */
public class ubah_pelanggan extends javax.swing.JDialog {
    ...
    int xx, xy;
    private service_pelanggan servis = new DAO_pelanggan();
    private table_pelanggan tblMod = new table_pelanggan();
    private model_pelanggan mod;
    
    public ubah_pelanggan(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        model_pelanggan mod = servis.getByID(id);
        tf_id.setText(mod.getId_pelanggan());
        tf_nama.setText(mod.getNama_pelanggan());
        tf_alamat.setText(mod.getAlamat_pelanggan());
        tf_tlp.setText(mod.getTlp_pelanggan());
    }
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if(validasiIn()){
            ...
            mod.setId_pelanggan(id);
            mod.setNama_pelanggan(nama);
            mod.setAlamat_pelanggan(alamat);
            mod.setTlp_pelanggan(tlp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ubah_pelanggan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ubah_pelanggan dialog = new ubah_pelanggan(new javax.swing.JFrame(), true,"id");
