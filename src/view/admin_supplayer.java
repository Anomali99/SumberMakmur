 ...
 * @author fatiq
 */
public class admin_supplayer extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Supplayer");
    ...
    private void btn_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_searchMouseClicked
        ...
        if(x.equals("Search")||x.trim().equals("")){
            ...
            List<model_supplayer> list = servis.pencarianData(x);
            tblMod.setData(list);
        }
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        if(x.equals("TAMBAH")){
            ...
            ubah_supplayer tp = new ubah_supplayer(null,closeable,id);
            tp.setVisible(true);
        }
        loadData();
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if(index != -1){
            model_supplayer mod = tblMod.getData(tbl_cont.convertRowIndexToModel(index));
