 ...
 * @author fatiq
 */
public class tambah_pelanggan extends javax.swing.JDialog {
    ...
    public tambah_pelanggan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                tambah_pelanggan dialog = new tambah_pelanggan(new javax.swing.JFrame(), true);
