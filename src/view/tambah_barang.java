...
public class tambah_barang extends javax.swing.JDialog {
    ...
    table_barang tblMod = new table_barang();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 120, 40));
        ...
        jPanel1.add(btn_batal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 220, 120, 40));
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if(validasiIn()){
            ...
            Long haraga = Long.parseLong(tf_harga.getText());
            String x = tf_stok.getText();
            int stok = 0;
            if(!x.trim().isEmpty())
             stok = Integer.parseInt(x);
