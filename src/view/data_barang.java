...
public class data_barang extends javax.swing.JDialog {
    ...
    private table_barang mod = new table_barang();
    public  model_barang pel = new model_barang();
    ...
    private void pencarian(){
        List<model_barang> list = servis.pencarianData(search.getText());
        mod.setData(list);
    }
    ...
    private void pilihData(){
        ...
        pel.setKode_barang(tbl_jenis.getModel().getValueAt(row, 1).toString());
        pel.setNama_barang(tbl_jenis.getModel().getValueAt(row, 2).toString());
        pel.setHarga((Long) tbl_jenis.getModel().getValueAt(row, 4));
        dispose();
    }
