 ...
 * @author fatiq
 */
public class admin_pelanggan extends javax.swing.JPanel {
    ...
    table_pelanggan tblMod = new table_pelanggan();
    
    public admin_pelanggan() {
        initComponents();
    ...
    private void btn_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_searchMouseClicked
        ...
        if(x.equals("Search")||x.trim().equals("")){
            ...
            List<model_pelanggan> list = servis.pencarianData(x);
            tblMod.setData(list);
        }
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        if(x.equals("TAMBAH")){
            ...
            tambah_pelanggan tp = new tambah_pelanggan(null,closeable);
            tp.setVisible(true);
        }else{
            boolean closeable = true;
            String id = tbl_cont.getModel().getValueAt(row, 1).toString();
            ubah_pelanggan tp = new ubah_pelanggan(null,closeable,id);
            tp.setVisible(true);
        }
        loadData();
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if(index != -1){
            model_pelanggan mod = tblMod.getData(tbl_cont.convertRowIndexToModel(index));
    ...
    private void loadData() {
        ...
        List<model_pelanggan> list = servis.ambilData();
        tblMod.setData(list);
